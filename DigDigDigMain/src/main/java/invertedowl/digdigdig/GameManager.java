...
public class GameManager {
    ...
    public void spawnTeamMobs() {
        ...
        int scale = 10;
        if (0 > teamsList.size() - 1) return;
        Slime slime1 = (Slime) world.spawnEntity(new Location(world, 0 , 72, -30 - scale + 4), EntityType.SLIME);
        slime1.setSize(1);
        slime1.setAI(false);
        teamsList.get(0).setTeamEntity(slime1);

        if (1 > teamsList.size() - 1) return;
        Slime slime2 = (Slime) world.spawnEntity(new Location(world, 0 , 72, 30 + scale - 4), EntityType.SLIME);
        slime2.setSize(1);
        slime2.setAI(false);
        teamsList.get(1).setTeamEntity(slime2);

        if (2 > teamsList.size() - 1) return;
        Slime slime3 = (Slime) world.spawnEntity(new Location(world, 30 + scale - 4, 72, 0 ), EntityType.SLIME);
        slime3.setSize(1);
        slime3.setAI(false);
        teamsList.get(2).setTeamEntity(slime3);

        if (3 > teamsList.size() - 1) return;
        Slime slime4 = (Slime) world.spawnEntity(new Location(world, -30 - scale + 4, 72, 0 ), EntityType.SLIME);
        slime4.setSize(1);
        slime4.setAI(false);
